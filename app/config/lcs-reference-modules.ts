...
export const lcsReferenceModules: FreightModule[] = [
  ...
  module({
    ...
    columns: [column('code', 'Code', 'លេខកូដ'), column('name', 'Name', 'ឈ្មោះ'), column('group', 'Group', 'ក្រុម'), column('version', 'Version', 'កំណែ'), column('description', 'Description', 'បរិយាយ'), column('attributeCount', 'Attribute Count', 'ចំនួនលក្ខណៈ'), column('status', 'Status', 'ស្ថានភាព')],
    fields: [field('code', 'Code', 'លេខកូដ', undefined, undefined, 'text', undefined, true), field('name', 'Name', 'ឈ្មោះ', undefined, undefined, 'text', undefined, true), field('description', 'Description', 'បរិយាយ', undefined, undefined, 'textarea', undefined, false, { colSpan: 2 }), field('group', 'Component Group', 'ក្រុមសមាសភាគ', 'Classification', 'ចំណាត់ថ្នាក់', 'text', undefined, true), field('version', 'Version', 'កំណែ', 'Version', 'កំណែ', 'text', undefined, true), field('status', 'Status', 'ស្ថានភាព', 'Control', 'ការគ្រប់គ្រង', 'select', ACTIVE_STATUS)],
    tables: [{
      key: 'attributes', title: 'Template Attributes', titleKm: 'លក្ខណៈគំរូ', addLabel: 'Add attribute',
      columns: [
        { key: 'code', label: 'Code', labelKm: 'លេខកូដ', required: true }, { key: 'label', label: 'Label', labelKm: 'ស្លាក', required: true }, { key: 'dataType', label: 'Data Type', labelKm: 'ប្រភេទទិន្នន័យ', type: 'select', options: ['Text', 'Number', 'Date', 'DateTime', 'Boolean', 'Reference', 'JSON'], required: true },
